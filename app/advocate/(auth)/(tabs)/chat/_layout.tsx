          ...
          <View className='flex-row mt-[10%] mx-[3%] items-center justify-center'>
              ...
              <View className='flex-row w-[60%] mx-[5%] items-center justify-start'>
                  ...
                  <View className='flex items-start justify-center mx-[1%]'>
                      <Text className='font-cbold text-Neutral-2 text-start' style={{fontSize: Math.round(fontScaledSizeRatio*17.5)}}>Client 1</Text>
                      <Text className='font-c text-primary-background text-start' style={{fontSize: Math.round(fontScaledSizeRatio*12)}}></Text>
                  </View>
              </View>
